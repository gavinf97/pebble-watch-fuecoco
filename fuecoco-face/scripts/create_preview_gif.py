...
Vendored from coredevices/pebble-watchface-agent-skill (scripts/create_preview_gif.py),
with the platform list narrowed to this project's flint (Pebble 2 Duo) target.
...
Creates:
    - preview_flint.gif (if emulator running)
